...
<section class="row">
  <form action="index.php?page=producto&mode={{mode}}&prdcod={{prdcod}}" 
      ...
      <input type="number" min="0" max="99999999" id="prdPrcVVnt" 
        ...
        placeholder="Precio de Venta" class="col-7" />
      </div>
      <div class="row">
        ...
        <input type="number" min="0" max="99999999" id="prdPrcCpm"
          ...
          placeholder="Precio de Compra" class="col-7" />
      </div>
      <div class="row">
      ...
      <div class="row">
        ...
        <select name="prdEst" id="prdEst" class="col-7">
          {{foreach estados}}
            <option value="{{prdest}}" {{selected}}>{{prdestest}}</option>
          {{endfor estados}}
        </select>
      </div>
      <div class="row">
        <label class="col-12" for="prdBio">Descripción</label>
        <textarea id="prdBio" name="prdBio" class="col-12">{{prdBio}}</textarea>
      </div>
      <div class="row">
